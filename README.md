...
This is a sample template for cities-list - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name cities-list --tail
```
...
```bash
aws cloudformation delete-stack --stack-name cities-list
```
